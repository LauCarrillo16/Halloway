...
('Andrés Gómez', 'Cajero', '3202345678', 'andres.gomez@example.com', TRUE),
...
('Luis Fernández', 'Jefe de Compras', '3606789012', 'luis.fernandez@example.com', TRUE),
('Cecilia Morales', 'Promotora', '3707890123', 'cecilia.morales@example.com', TRUE),
('Jorge Díaz', 'Vendedor', '3808901234', 'jorge.diaz@example.com', TRUE),
('Ana Jiménez', 'Cajera', '3909012345', 'ana.jimenez@example.com', TRUE),
('Miguel Ángel Suárez', 'Gerente de Ventas', '3002345678', 'miguel.suarez@example.com', TRUE),
('Tatiana Castaño', 'Asistente de Compras', '3103456789', 'tatiana.castano@example.com', TRUE),
('Diego Martínez', 'Encargado de Almacén', '3204567890', 'diego.martinez@example.com', TRUE),
('Lucía Gutiérrez', 'Analista de Ventas', '3305678901', 'lucia.gutierrez@example.com', TRUE),
('Felipe Gómez', 'Vendedor', '3406789012', 'felipe.gomez@example.com', TRUE),
('Valentina Ramírez', 'Asistente Contable', '3507890123', 'valentina.ramirez@example.com', TRUE),
('Cristian Vargas', 'Auxiliar de Almacén', '3608901234', 'cristian.vargas@example.com', TRUE),
('Isabella Herrera', 'Jefe de Ventas', '3709012345', 'isabella.herrera@example.com', TRUE),
...
('Juliana Romero', 'Asistente Administrativo', '3103456789', 'juliana.romero@example.com', TRUE),
...
('Diana Salazar', 'Jefe de Almacén', '3507890123', 'diana.salazar@example.com', TRUE),
('Hernán Ocampo', 'Auxiliar de Ventas', '3608901234', 'hernan.ocampo@example.com', TRUE),
('Sara Acosta', 'Asistente Contable', '3709012345', 'sara.acosta@example.com', TRUE),
('Luis Miguel Torres', 'Vendedor', '3800123456', 'luis.torres@example.com', TRUE),
('Karla Fernández', 'Cajera', '3901234567', 'karla.fernandez@example.com', TRUE),
('Felipe Alvarado', 'Gerente de Almacén', '3002345678', 'felipe.alvarado@example.com', TRUE),
...
('Adriana Castillo', 'Vendedora', '3305678901', 'adriana.castillo@example.com', TRUE),
('Julián Reyes', 'Cajero', '3406789012', 'julian.reyes@example.com', TRUE),
('Sandra Ospina', 'Auxiliar de Almacén', '3507890123', 'sandra.ospina@example.com', TRUE),
('Camilo Ortega', 'Jefe de Ventas', '3608901234', 'camilo.ortega@example.com', TRUE),
('Mónica Castro', 'Asistente Administrativo', '3709012345', 'monica.castro@example.com', TRUE),
('Andrés Torres', 'Cajero', '3800123456', 'andres.torres@example.com', TRUE),
('Mariana Castaño', 'Vendedora', '3901234567', 'mariana.castano@example.com', TRUE),
('Carlos Alberto Pérez', 'Supervisor', '3002345678', 'carlos.perez@example.com', TRUE),
('Gisela Martínez', 'Asistente Contable', '3103456789', 'gisela.martinez@example.com', TRUE),
('Oswaldo Gómez', 'Jefe de Compras', '3204567890', 'oswaldo.gomez@example.com', TRUE),
('Paola Ramírez', 'Cajera', '3305678901', 'paola.ramirez@example.com', TRUE),
('Nicolás López', 'Vendedor', '3406789012', 'nicolas.lopez@example.com', TRUE);
